...
流程: START → parse_query → sql_generate → execute_sql → render → END
"""
...
from ._nodes import execute_sql, parse_query, render, sql_generate
...
class GraphQueryWorkflow:
    ...
    持有编译后的 CompiledGraph，schema 通过闭包注入到 sql_generate 节点。
    """
    ...
    def _build(self):
        ...
        builder.add_edge("execute_sql", "render")
